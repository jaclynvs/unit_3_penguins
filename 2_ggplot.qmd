...
Now we will learn how to visualize your data using `ggplot2.` R has several systems for making graphs, but `ggplot2` is one of the most elegant and most versatile. You can do more faster by learning one system and applying it to many different types of figures. Once you have gone through the basics, it can be helpful to look at a ggplot cheat sheet to remind yourself about functionality and syntax or to learn more. Posit has a nice "Data Visualization with ggplot2" cheat sheet: <https://posit.co/wp-content/uploads/2022/10/data-visualization-1.pdf> 
...
I don't really know that much about penguins. For example, how long is a penguin beak? Like a couple of centimeters? What about a flipper length? Let's plot a quick histogram and get a sense of the data:
...
There are tons of options for saving your figures, and you can look through the ggsave() documentation to learn more. (Remember, do this by typing `?ggsave` into the console).
